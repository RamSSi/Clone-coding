const quotes = [
  ...
  {
    quote: "생명이 있는 한 희망이 있다.\n실망을 친구로 삼을 것인가, 아니면 희망을 친구로 삼을 것인가.",
    author: "J.위트",
  },
  {
    quote: "실패란 넘어지는 것이 아니라,\n넘어진 자리에 머무는 것이다.",
    author: "책 ‘프린세스, 라 브라바!’ 中",
  },
  {
    quote: "슬픔이 그대의 삶으로 밀려와 마음을 흔들고\n소중한 것을 쓸어가 버릴 때면 그대 가슴에 대고 말하라.\n“이것 또한 지나가리라”",
    author: "랜터 윌슨 스미스",
  },
]
